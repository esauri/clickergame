...
game.Emitter=function(){
	...
	function initParticle(obj, p, emitterPoint){
		...
		p.age = Emitter.utilities.getRandomInt(0,obj.lifetime);
				
		p.x = emitterPoint.x + Emitter.utilities.getRandom(-obj.xRange, obj.xRange);
		p.y = emitterPoint.y + Emitter.utilities.getRandom(0, obj.yRange);
		p.r = Emitter.utilities.getRandom(obj.startRadius/2, obj.startRadius); // radius
		p.xSpeed = Emitter.utilities.getRandom(obj.minXspeed, obj.maxXspeed);
		p.ySpeed = Emitter.utilities.getRandom(obj.minYspeed, obj.maxYspeed);
		return p;
	};
